// Omnibus Accounts
pub const CREDIT_COLLATERAL_OMNIBUS_ACCOUNT_SET_NAME: &str =
    "Credit Collateral Omnibus Account Set";
...
pub const CREDIT_FACILITY_REMAINING_ACCOUNT_SET_REF: &str = "credit-facility-remaining-account-set";
