...
export const mockJob = (overrides?: Partial<Job>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Job' } & Job => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    ...
    return {
        ...
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : faker.string.uuid(),
        jobId: overrides && overrides.hasOwnProperty('jobId') ? overrides.jobId! : generateMockValue.uuid(),
        jobType: overrides && overrides.hasOwnProperty('jobType') ? overrides.jobType! : faker.lorem.word(),
        lastError: overrides && overrides.hasOwnProperty('lastError') ? overrides.lastError! : faker.lorem.word(),
        status: overrides && overrides.hasOwnProperty('status') ? overrides.status! : JobStatus.Completed,
    };
};
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        job: overrides && overrides.hasOwnProperty('job') ? overrides.job! : relationshipsToOmit.has('Job') ? {} as Job : mockJob({}, relationshipsToOmit),
